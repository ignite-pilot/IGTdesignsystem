...
<div class="dialog" data-size="sm" data-variation="primary" role="dialog" aria-modal="true">
  ...
  <div class="dialog__footer">
    <button type="button" class="btn" data-tone="primary" data-appearance="fill" data-emphasis="strong" data-size="md"><span class="btn-label-wrap"><span class="btn-label">확인</span></span><span class="btn-focus-ring" aria-hidden></span></button>
  </div>
</div>`,
      },
      {
...
<div class="dialog" data-size="sm" data-variation="primary" role="dialog" aria-modal="true" aria-describedby="dialog-description">
  ...
  <div class="dialog__footer">
    <button type="button" class="btn" data-tone="secondary" data-appearance="fill" data-emphasis="weak" data-size="md"><span class="btn-label-wrap"><span class="btn-label">취소</span></span><span class="btn-focus-ring" aria-hidden></span></button>
    <button type="button" class="btn" data-tone="primary" data-appearance="fill" data-emphasis="strong" data-size="md"><span class="btn-label-wrap"><span class="btn-label">삭제</span></span><span class="btn-focus-ring" aria-hidden></span></button>
  </div>
</div>`,
      },
      {
...
<div class="dialog" data-size="sm" data-variation="danger" role="dialog" aria-modal="true" aria-describedby="dialog-description">
  ...
  <div class="dialog__footer">
    <button type="button" class="btn" data-tone="secondary" data-appearance="fill" data-emphasis="weak" data-size="md"><span class="btn-label-wrap"><span class="btn-label">취소</span></span><span class="btn-focus-ring" aria-hidden></span></button>
    <button type="button" class="btn" data-tone="danger" data-appearance="fill" data-emphasis="strong" data-size="md"><span class="btn-label-wrap"><span class="btn-label">삭제</span></span><span class="btn-focus-ring" aria-hidden></span></button>
  </div>
</div>`,
      },
      {
  ...
  <div class="drawer__footer">
    ...
    <div class="drawer__footer-actions" data-variation="primary" data-layout="inlineEnd">
      <div class="drawer__footer-end-group">
        <button type="button" class="btn" data-tone="primary" data-appearance="fill" data-emphasis="strong" data-size="md"><span class="btn-label-wrap"><span class="btn-label">저장</span></span><span class="btn-focus-ring" aria-hidden></span></button>
      </div>
    </div>
  </div>
</div>`,
...
<div class="drawer" data-placement="right" data-size="sm" role="dialog" aria-modal="true">
  ...
  <div class="drawer__footer">
    ...
    <div class="drawer__footer-actions" data-variation="primary" data-layout="between">
      <button type="button" class="btn" data-tone="danger" data-appearance="outline" data-emphasis="weak" data-size="md"><span class="btn-label-wrap"><span class="btn-label">삭제</span></span><span class="btn-focus-ring" aria-hidden></span></button>
      <div class="drawer__footer-end-group">
        <button type="button" class="btn" data-tone="secondary" data-appearance="fill" data-emphasis="weak" data-size="md"><span class="btn-label-wrap"><span class="btn-label">취소</span></span><span class="btn-focus-ring" aria-hidden></span></button>
        <button type="button" class="btn" data-tone="primary" data-appearance="fill" data-emphasis="strong" data-size="md"><span class="btn-label-wrap"><span class="btn-label">저장</span></span><span class="btn-focus-ring" aria-hidden></span></button>
      </div>
