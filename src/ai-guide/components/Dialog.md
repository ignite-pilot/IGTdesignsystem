...
Footer 버튼은 IGT `<Button>` 컴포넌트로 위임 렌더된다. `variation` 은 Button 의 `tone/appearance/emphasis` 조합으로 매핑된다.

| variation | Primary 버튼 Button props | Secondary 버튼 Button props |
|-----------|---------------------------|------------------------------|
