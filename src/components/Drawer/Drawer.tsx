...
type FooterVariation = 'primary' | 'neutral' | 'danger'

type ButtonTokens = Pick<ButtonProps, 'tone' | 'appearance' | 'emphasis'>

const PRIMARY_BY_VARIATION: Record<FooterVariation, ButtonTokens> = {
...
const TERTIARY_TOKENS: ButtonTokens = {
  tone: 'danger',
  appearance: 'outline',
  emphasis: 'weak',
}
                ...
                <div className="drawer__footer-end-group">
                  ...
                  {primaryLabel && (
                    <Button
                      ...
                      size="md"
                      onClick={onPrimary}
                      {...PRIMARY_BY_VARIATION[footerVariation]}
                    >
                      {primaryLabel}
                    </Button>
                  )}
