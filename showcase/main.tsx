...
import { TableDataHeaderShowcase } from './TableDataHeaderShowcase'
    ...
    <>
      ...
      <div className="sc-layout">
        ...
        <main className="sc-content">
          ...
          <HR />
          <section id="table-data-header"><TableDataHeaderShowcase /></section>
          <HR />
          ...
          <HR />
          <section id="detail-edit"><DetailEditPage /></section>
        </main>
      </div>
    </>
  )
